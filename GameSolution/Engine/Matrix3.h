...
namespace Engine {
	...
	struct Matrix3 {
		...
		inline static Matrix3 rotation(float a) {
			return Matrix3(Vector2(cos(a), sin(a)), Vector2(-sin(a), cos(a)));
		}

		inline static Matrix3 scale(float s) {
			return Matrix3(Vector2(s, 0), Vector2(0, s));
		}

		inline static Matrix3 scaleX(float s) {
			return Matrix3(Vector2(s, 0), Vector2(0, 1));		
		}

		inline static Matrix3 scaleY(float s) {
		...
		inline static Matrix3 translation(const Vector2& v) {
